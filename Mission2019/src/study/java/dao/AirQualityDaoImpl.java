...
public class AirQualityDaoImpl implements AirQualityDao{
	...
	public List<AirQualityItem> getAirQualityList(String keyword) {
		...
		// Kakao OpenAPI 주소
		String dataurl = "http://openAPI.seoul.go.kr:8088/70796c7a786f6b7137305a42645079/json/MonthlyAverageAirQuality/1/25/201903?MSRSTE_NM=" + msrste_nm + "O3=" + o3 + "PM10=" + pm10 + "PM25=" + pm25;
