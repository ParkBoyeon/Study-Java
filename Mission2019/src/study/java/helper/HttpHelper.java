...
public class HttpHelper {
	...
	public InputStream getWebData(String url, String encType, Map<String, String> header) {
		...
		// 접속 대기에 대한 제한시간 --> 밀리세컨드 단위 
				...
				/** HTTPS 프로토콜에 접근하기 위한 인증처리 */
				try {
					// SSL 인증을 수행할 수 있는 객체를 생성하고 초기화한다. 
					// --> import javax.netssl.SSLContext;
					...
					// 접속 기능을 하는 객체에게 SSL 인증 내용을 적용한다.
				...
				if (header != null) {
					// Map 객체로 전달된 Header의 모든키에 대한 스캔 (향상된 for문 사용)
