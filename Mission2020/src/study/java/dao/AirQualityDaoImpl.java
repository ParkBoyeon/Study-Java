...
public class AirQualityDaoImpl implements AirQualityDao{
	...
	public List<AirQualityItem> getAirQualityList(String keyword) {
		...
		// Kakao OpenAPI 주소
		String dataurl = "http://openAPI.seoul.go.kr:8088/70796c7a786f6b7137305a42645079/json/MonthlyAverageAirQuality/1/25/202003?MSRSTE_NM=" + msrste_nm + "O3=" + o3 + "PM10=" + pm10 + "PM25=" + pm25;
		
		// 발급받은 REST API키를 "KakaoAK REST_API_키"형식으로 정의한다.(공백주의)
		...
		for (int i = 0; i < row.length(); i++) {
			...
			//String o3 = String.format("%.3f", O3);
			//o3 = Math.round((O3*100)/10.0);
